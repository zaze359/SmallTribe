...
package com.zaze.tribe.music.glide.palette;
...
import com.zaze.tribe.music.util.ColorUtil;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap,  BitmapPaletteWrapper> {
  ...
  public Resource<BitmapPaletteWrapper> transcode(@NonNull Resource<Bitmap> toTranscode, @NonNull Options options) {
    ...
    BitmapPaletteWrapper bitmapPaletteWrapper =
            new BitmapPaletteWrapper(bitmap, ColorUtil.INSTANCE.generatePalette(bitmap));
